...
export function ItemCard({ item, priceAlign = "right", imageWidth = 200, height = 200, nameSize = 24, nameNoWrap = false }: { item: MenuItem; priceAlign?: "left" | "right"; imageWidth?: number; height?: number; nameSize?: number; nameNoWrap?: boolean }) {
  return (
    <div style={{ display: "flex", width: 420, height, background: PANEL }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", paddingLeft: 28, paddingRight: 30, paddingTop: 22, paddingBottom: 24 }}>
        <span style={{ fontFamily: mincho, fontSize: nameSize, fontWeight: 600, letterSpacing: "2px", color: "#fff", lineHeight: 1.3, whiteSpace: nameNoWrap ? "nowrap" : "normal" }}>{item.name}</span>
        <div style={{ flex: 1 }} />
