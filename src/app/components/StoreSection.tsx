      ...
      <div style={{ paddingLeft: 50, paddingRight: 50, display: "flex", flexDirection: "column", gap: 40 }}>
        ...
        <div style={{ display: "flex", height: 350 }}>
          <div style={{ width: 742, height: 350, position: "relative", overflow: "hidden", background: "#1c110a", flexShrink: 0 }}>
            <Image src={images?.kameoka ?? "/images/store_kameoka.webp"} alt="平壌亭 亀岡店" fill className="object-cover" sizes="742px" />
          </div>
          <InfoPanel
        ...
        <div style={{ display: "flex", gap: 40, height: 280 }}>
          <div style={{ width: 650, display: "flex", flexShrink: 0 }}>
            <div style={{ width: 280, height: 280, position: "relative", overflow: "hidden", background: "#1c110a", flexShrink: 0 }}>
              <Image src={images?.sonobe ?? "/images/store_sonobe_map.webp"} alt="平壌亭 園部店" fill className="object-cover" sizes="280px" />
            </div>
            <InfoPanel
          ...
          <div style={{ width: 650, display: "flex", flexShrink: 0 }}>
            <div style={{ width: 280, height: 280, position: "relative", overflow: "hidden", background: "#1c110a", flexShrink: 0 }}>
              <Image src={images?.fukuchiyama ?? "/images/store_fukuchiyama_map.webp"} alt="平壌亭 福知山店" fill className="object-cover" sizes="280px" />
            </div>
            <InfoPanel
        ...
        <div style={{ display: "flex", gap: 40, height: 280 }}>
          <div style={{ width: 650, display: "flex", flexShrink: 0 }}>
            <div style={{ width: 280, height: 280, position: "relative", overflow: "hidden", background: "#1c110a", flexShrink: 0 }}>
              <Image src={images?.yurano ?? "/images/store_yurano.webp"} alt="焼肉ゆらの" fill className="object-cover" sizes="280px" />
            </div>
            <InfoPanel
              ...
              hours={<p style={{ lineHeight: "22px" }}>11:30〜15:00(LO14:30) / 17:00〜22:00(LO21:30)</p>}
              closed="定休日 火曜"
              paddingLeft={40}
              paddingTop={29}
              nameMaxWidth={320}
