        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 17, maxWidth: article.hideHero ? 980 : 440 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            {article.tags.map((tag, i) => (
              <span
                key={i}
                style={{ display: "flex", alignItems: "center", justifyContent: "center", minWidth: 60, padding: "0 8px", whiteSpace: "nowrap", flexShrink: 0, height: 20, backgroundColor: tag.color, borderRadius: 10, fontFamily: mincho, fontSize: 10, fontWeight: 700, color: "#fff" }}
              >
                {tag.label}
              </span>
            ))}
