    ...
    <a ref={ref} href={`/news/${item.id}`} style={{ width: CARD_WIDTH, display: "flex", flexDirection: "column", gap: 12, textDecoration: "none" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        {item.tags.map((tag, ti) => (
          <span key={ti} style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "0 8px", whiteSpace: "nowrap", height: 20, backgroundColor: tag.color, borderRadius: 10, fontFamily: mincho, fontSize: 10, fontWeight: 700, color: "#fff" }}>
            {tag.label}
          </span>
        ))}
      </div>
    ...
    <div style={{ display: "flex", flexDirection: "column", width: 390, height, background: "#0a0a0a", overflow: "hidden" }}>
      ...
      <div style={{ paddingLeft: 19 }}>
        <div style={{ position: "relative", width: 351, height: 130, overflow: "hidden", background: "#472914" }}>
          <Image src="/images/newslist_group.webp" alt="集合写真" fill className="object-cover" style={{ objectPosition: "center 85%" }} sizes="351px" preload />
